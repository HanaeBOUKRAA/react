    ...
    const columns = useMemo(()=> {
        return [
            {field: "image", headerName: "Profile Image", width: 150, 
                renderCell: () => <Avatar>U</Avatar>, sortable:false, filterable:false},
            ...
            {field: "/", headerName: "Contact",
                renderCell: (params) => <Button onClick={() => 
                    ...
                    variant="contained" endIcon={<SendIcon />}>Message</Button>, width: 200}
           ]
    });
    ...
    return (
        <Box style={outerContainer}>
            <Box style={headerStyles}>
                ...
                <Box>
                    <Button style={{margin: '20px 0px'}} variant="contained" color="primary" onClick={() => {
                        Accounts.logout();
